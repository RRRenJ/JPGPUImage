...
@property (nonatomic, assign) CMTime cureentPlayTime;
@property (nonatomic, assign) BOOL isClib;
@property (nonatomic, assign) CMTimeRange playTimeRange;
@property (readonly, nonatomic) AVAssetReader *assetReader;
@property (readonly, nonatomic) BOOL audioEncodingIsFinished;
@property (readonly, nonatomic) BOOL videoEncodingIsFinished;
@property (readwrite, strong) AVMutableVideoComposition *videoComposition;
