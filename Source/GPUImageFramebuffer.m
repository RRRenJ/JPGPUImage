...
- (id)initWithSize:(CGSize)framebufferSize textureOptions:(GPUTextureOptions)fboTextureOptions onlyTexture:(BOOL)onlyGenerateTexture;
{
    ...
    if (framebufferSize.width <= 1.0 || isnan(framebufferSize.width)) {
        framebufferSize.width = 1080;
    }
    if (framebufferSize.height <= 1.0 || isnan(framebufferSize.width)) {
        framebufferSize.height = 1080;
    }
