...
@synthesize cureentPlayTime = _cureentPlayTime;
@synthesize isClib = _isClib;
...
#warning Missing OSX implementation
    ...
    assetReader.timeRange = self.playTimeRange;
    return assetReader;
}
...
- (void)processAsset
{
    ...
    {
        while (reader.status == AVAssetReaderStatusReading && (!_shouldRepeat || keepLooping) && isProgress)
        {
...
- (void)displayLinkCallback:(CADisplayLink *)sender
{
    ...
    _cureentPlayTime = outputItemTime;
    [self updatePlayTime];
