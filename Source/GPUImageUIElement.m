...
{
//    @autoreleasepool {
//        CGFloat maxSize = MAX(view.bounds.size.width, view.bounds.size.height);
//        CGFloat scale = 1.0;
//        if (maxSize > 1280) {
//            scale = 1280 / maxSize;
//        }
...
//        GPUImagePicture *pictrue  = [[GPUImagePicture alloc] initWithImage:image];
//        outputFramebuffer = pictrue.framebufferForOutput;
