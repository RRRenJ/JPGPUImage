...
@synthesize isAddVideoEnd = _isAddVideoEnd;
@synthesize videoTotalDuration = _videoTotalDuration;
@synthesize isLockBuffer = _isLockBuffer;
#pragma mark -
...
- (id)initWithVertexShaderFromString:(NSString *)vertexShaderString fragmentShaderFromString:(NSString *)fragmentShaderString;
{
    ...
    _videoTotalDuration = kCMTimeZero;
    _isAddVideoEnd = NO;
    _isLockBuffer = NO;
...
- (void)informTargetsAboutNewFrameAtTime:(CMTime)frameTime;
{
    ...
    if (usingNextFrameForImageCapture || _isLockBuffer)
    {
//        usingNextFrameForImageCapture = NO;
    }
    else
...
- (void)newFrameReadyAtTime:(CMTime)frameTime atIndex:(NSInteger)textureIndex;
{
    ...
    if (_isAddVideoEnd == YES && CMTimeCompare(frameTime, _videoTotalDuration) > 0) {
