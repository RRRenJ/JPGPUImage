...
typedef struct GPUMatrix2x2 GPUMatrix2x2;
...
@property (nonatomic, assign) BOOL isAddVideoEnd;
@property (nonatomic, assign) BOOL isLockBuffer;

@property (nonatomic, assign) CMTime videoTotalDuration;
